    ...
    if (isset($_POST['enviar']) && $entradaOk==true){
        ...
        try{
            ...
            if($consulta->rowCount()!=0){ 
                ...
                $accesos=$resultado->NumeroAccesos;
                $login=true;
        ...
        if ($login){
            ...
            $_SESSION['usuario']  = $usuario; //cargamos la sesion del usuario
            $_SESSION['ultimaconexion']=$ultimaconexion;
            $_SESSION['NumeroAccesos']=$accesos;
            try{
            //consulta que actualiza el numero de accesos y la hora de ultima conexion
