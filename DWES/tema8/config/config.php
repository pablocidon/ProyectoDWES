...
$vistas=[
    ...
    "bajaUsuario"=>"vista/vBajaUsuario.php",
    "rehabilitarUsuario"=>"vista/vRehabilitarUsuario.php",
    "wip"=>'vista/vWIP.php',
...
$controladores=[
    ...
    "bajaUsuario"=>"controlador/cBajaUsuario.php",
    "rehabilitarUsuario"=>"controlador/cRehabilitarUsuario.php",
    "wip"=>'controlador/cWIP.php',
