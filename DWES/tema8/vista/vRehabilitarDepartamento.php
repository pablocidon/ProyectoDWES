<form name="formulario" class="form-horizontal" action="index.php?Departamento=<?php echo $_GET['Departamento'];?>&pagina=rehabilitar&numeroPagina=<?php echo $_GET['numeroPagina'];?>" method="post" style="width: 100%">
    <fieldset>
        <h4>¿Rehabilitar el departamento?</h4>
