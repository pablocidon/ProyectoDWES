...
<form name="formulario" class="" action="index.php?pagina=mantenimientoOpiniones" method="post" style="width: 100%; ">
    <fieldset>
        <div class="row">
        ...
        <div class="form-group row">
            <!-- Material input -->
            <label for="inputPassword3MD" class="col-sm-2 col-form-label">Codigo USUARIO:</label>
            <div class="col-sm-8">
        ...
        <table class="table">
            ...
            for ($i=0;$i<count($opinion);$i++){
               /// if(is_null($departamentos[$i]->getFechaBajaDepartamento())){
                    ...
                    echo "<td class='text-center'>". $opinion[$i]->getCodUsuario() ."</td>";
                    echo "<td>". $opinion[$i]->getCodCuestion() ."</td>";
                    echo "<td>". $opinion[$i]->getValorRespuesta() ."</td>";
