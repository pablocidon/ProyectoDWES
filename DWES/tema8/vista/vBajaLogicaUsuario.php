<form name="formulario" class="form-horizontal" action="index.php?Usuario=<?php echo $_GET['CodUsuario'];?>&pagina=bajaUsuario&numeroPagina=<?php echo $_GET['numeroPagina'];?>" method="post" style="width: 100%">
    <fieldset>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <input type="text" class="form-control col-sm-2 text-center" id="alfabetico" name="Alta" value="<?php echo $usuario->getPerfil(); //Obtenemos la fecha en la que el departamento ha sido dado de alta.?>" readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <input type="text" class="form-control col-sm-1 text-center" id="alfabetico" name="ultimaConexion" value="<?php echo $usuario->getUltimaConexion; //Obtenermos el volumen de negocio del departamento?>" readonly>
