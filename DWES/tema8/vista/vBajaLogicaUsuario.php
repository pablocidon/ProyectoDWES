<form name="formulario" class="form-horizontal" action="index.php?Usuario=<?php echo $_GET['Usuario'];?>&pagina=bajaLogicaUsuario&numeroPagina=<?php echo $_GET['numeroPagina'];?>" method="post" style="width: 100%">
    <fieldset>
