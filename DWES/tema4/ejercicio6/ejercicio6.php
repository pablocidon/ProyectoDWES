    ...
    <div class="row col-md-12 tecnologias"> 
        ...
        require "../conexionDB.php";//se usa un archivo externo que contiene los datos de la conexion 
            ...
            try{//la conexion a la base de datos se introduce en un bloque try-catch 
                ...
                //ahora recorremos el array de departamentos y ejecutamos la insercion por cada uno usando foreach  
                foreach($arrayDepartamentos as $elemento){//se recorren los departamentos con foreach
                     $codDepartamento=$elemento['codDepartamento'];//asignamos el valor del codigo
                     $descDepartamento=$elemento['descDepartamento'];//asignamos el valor de la descripcion
