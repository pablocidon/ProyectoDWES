...
<form name="formularioAlta" class="form-horizontal" action="index.php?pagina=modificar&Departamento=<?php echo $_GET['Departamento']?>" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" id="float" name="FechaAlta" placeholder="" value="<?php if(isset($_POST['editar'])){ echo $_POST['FechaAlta'],'"';}else{ echo $departamento->getFechaAltaDepartamento();}//Mostramos la fecha en la que el departamento ha sido creado?>" readonly>
                <?php //si existe mensaje de error lo mostramos
