        ...
        <form name="formulario" class="form-horizontal" action="index.php?pagina=registrar" method="post">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="alfabetico" name="descripcion" <?php if(isset($_POST['descripcion']) && empty($mensajeError['errorDescripcion'])){ echo 'value="',$_POST['descripcion'],'"';}?> >
                         <?php //si existe mensaje de error lo mostramos
